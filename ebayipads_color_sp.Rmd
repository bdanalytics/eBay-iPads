...
title: "eBay:iPads:: startprice regression:: color_sp"
author: "bdanalytics"
...
glb_append_stop_words[["descr.my"]] <- c(NULL
    ...
    ,"abused","across","adaptor","add","antenna","anti","anyone", "area","arizona","att"
                        ,"beginning","besides","bidder","bonus","boot","bound","bruises"
    ,"changed","changing","chrome","closely"
    ...
    ,"date","daughter","decent","defender","defense","degree","depicted"
        ...
        ,"either","emblem","erased","ereader","essentially","every","exact","exhibition"
                ,"facing","faint","film","final","flickers","folding","forgot","forwarders"
                                        ,"generic","genuine","glitter","goes","grey"
                            ,"half","handstand","hdmi","high","higher","hole","hospital"
                                        ,"immaculate","impact","instead","interior"
                                        ,"jack","july"
                                        ,"keeps","kind","known"
    ...
    ,"paperwork","period","pet","photograph","played","plug"
        ,"poor","portion","pouch","price","provided"
    ,"ranging","rather"
        ,"receipt","recently","red","reflected","refunds","remote","repeat"
            ,"required","reserve","residue","result"
        ,"ringer","roughly","running"
    ,"said","school","seconds","seem","semi","send","september","serious","setup"
        ,"shell","short","site","size","slice","smoke","smooth"
