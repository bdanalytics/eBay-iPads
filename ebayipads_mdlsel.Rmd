...
title: "eBay:iPads:: sold classification:: mdlsel"
author: "bdanalytics"
...
D.ratio.nstopwrds.nwrds                           10.51165302
    ...
    All.X.gbm: Leaderboard: not submitted yet
        newobs_tbl=[N=582, Y=216]; submit_filename=0_submit_mdlsel_Final_gbm_submit
...
glb_derive_lst[["startprice.unit9"]] <- list(
    mapfn=function(startprice) { return(as.numeric((as.integer(startprice) %% 10) == 9)) }
    , args=c("startprice"))
...
if (glb_is_regression)
    glb_models_method_vctr <- c("lm", "glm", "bayesglm", "glmnet", "rpart", "rf", "gbm") else
# Classification
    if (glb_is_binomial)
...
glb_exclude_vars_as_features <- c(glb_exclude_vars_as_features, 
                                  "startprice.log", "startprice.log.predict.")
###                                  
...
#model_id_pfx <- "All.X"
    ...
    if (model_id_pfx == "All.Interact.X") {
        ...
        indep_vars_vctr <- union(setdiff(indep_vars_vctr, 
                        c("startprice.diff", "startprice.unit9", "biddable", "cellular.fctr", "carrier.fctr")),
                            c("startprice.diff*biddable", "startprice.unit9*biddable", "cellular.fctr*carrier.fctr"))
        ###
        # _sp only
#         interact_vars_vctr <- c(
...
if (glb_is_regression) {
    ...
    if (!is.null(glb_category_var)) {
        ...
        sOOB_ctgry_df <- dplyr::count(sOOB_ctgry_df, 
                                      startprice.log.OOB.sum = sum(startprice.log),
