...
title: "eBay:iPads:: sold classification:: ctgry2"
author: "bdanalytics"
...
glb_to_sav <- function() {
    ...
    if (!is.null(glb_featsimp_df)) sav_featsimp_df <<- glb_featsimp_df    
}
#stop(here"); glb_to_sav(); glb_allobs_df <- sav_allobs_df; glb_trnobs_df <- sav_trnobs_df; glb_fitobs_df <- sav_fitobs_df; glb_OOBobs_df <- sav_OOBobs_df; ; glb_models_lst <- sav_models_lst; sav_models_df <- glb_models_df; glb_models_df <- sav_models_df; sav_featsimp_df <- glb_featsimp_df; glb_featsimp_df <- sav_featsimp_df    

if (!is.null(glb_sel_mdl_id) & (glb_sel_mdl_id == "Ensemble.glmnet")) {
    if ((glb_is_regression) | 
        ((glb_is_classification) & (!glb_is_binomial)))
        stop("Ensemble models not implemented yet for regression & multinomial classification")
