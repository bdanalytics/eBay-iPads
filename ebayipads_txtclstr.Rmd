...
title: "eBay:iPads:: sold classification:: txtclstr"
author: "bdanalytics"
...
for (row_pos in c(178, 948, 1514, 1904, 2157, 2210)) {
...
tmp_newobs_df$.err <- ((tmp_newobs_df[, rsp_var_out] == "Y") & (tmp_newobs_df$sold.0 > 0) |
                       (tmp_newobs_df[, rsp_var_out] == "N") & (tmp_newobs_df$sold.1 > 0))
